...
IF(WIN32)
  IF(MSVC)
    ...
    IF (CMAKE_BUILD_TYPE STREQUAL "Release")
      message (STATUS "    searching ${GLOG_ROOT}/Release/libglog_static.lib ...")
      FIND_LIBRARY(GLOG_LIBRARIES NAMES libglog_static.lib HINTS ${GLOG_ROOT}/Release $ENV{LIB} PATH_SUFFIXES ".lib")
    ELSE (CMAKE_BUILD_TYPE STREQUAL "Release")
      message (STATUS "    searching ${GLOG_ROOT}/Debug/libglog_static.lib ...")
      FIND_LIBRARY(GLOG_LIBRARIES NAMES libglog_static.lib HINTS ${GLOG_ROOT}/Debug $ENV{LIB} PATH_SUFFIXES ".lib")
